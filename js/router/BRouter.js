L.BRouter = L.Class.extend({
    ...
    getUrlParams: function(latLngs, format) {
        ...
        if (format != null) {
            ...
            if ((params.profile === Object.values(BR.conf.profiles)[0]) || !(Object.values(BR.conf.profiles).includes(params.profile) || params.profile.startsWith("custom_")))
    ...
    parseUrlParams: function(params) {
        ...
        if (params.profile && (Object.values(BR.conf.profiles).includes(params.profile) || params.profile.startsWith("custom_"))) {
